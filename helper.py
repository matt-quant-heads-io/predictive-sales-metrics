...
def get_eod_api_data_by_ticker(ticker, df_sm):
    try:
        ...
        req_url = EODHD_URL_FOR_FINANCIALS.format(ticker=ticker.upper(), api_token=EODHD_API_TOKEN)
        ...
        df_rev_all_columns["Rev % Change"] = ((df_rev_all_columns["Total Revenue By Quarter"] - df_rev_all_columns["Total Revenue By Quarter"].shift(-4))/df_rev_all_columns["Total Revenue By Quarter"].shift(-4))*100
        df_rev_all_columns = df_rev_all_columns[df_rev_all_columns.index >= oldest_dt_from_sm]
